                ...
                <TableRow key={s.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      ...
                      <Button isIconOnly size="sm" variant="light" onPress={() => move(i, 1)} isDisabled={i === subjects.length - 1}><ArrowDown size={14} /></Button>
                      {editingId === s.id && (
                        <Button isIconOnly size="sm" variant="flat" color="primary" onPress={() => commitEdit(s)}><Save size={14} /></Button>
                      )}
                      <Button isIconOnly size="sm" variant="light" color="danger" onPress={() => remove(s)}><Trash2 size={14} /></Button>
                    </div>
                  </TableCell>
                </TableRow>
              ))}
